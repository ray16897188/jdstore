...
Product.create!([title: "Coffee with Xdite", description: "预订与 Xidite 一小时的咖啡时间。Xdite 答疑解惑，点拨启发。", price: 50, quantity: 20000])
Product.create!([title: "台湾金书奖《Growth Hack这样做》", description: "Xdite 畅销书，好评如潮，最新翻印。", price: 2000, quantity: 100])
Product.create!([title: "Xdite 周边公仔", description: "限量发行，粉丝必备手办！", price: 20000, quantity: 5])
